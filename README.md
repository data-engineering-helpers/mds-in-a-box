...
* [Modern Data Stack (MDS) in a box](#modern-data-stack-mds-in-a-box)
  ...
  * [End\-to\-end projects](#end-to-end-projects)
    ...
    * [End\-to\-end restaurant analysis](#end-to-end-restaurant-analysis)
      * [DataBricks \- End\-to\-end restaurant analysis](#databricks---end-to-end-restaurant-analysis)
      * [Medallion \- End\-to\-end restaurant analysis](#medallion---end-to-end-restaurant-analysis)
      * [Data Vault \- End\-to\-end restaurant analysis](#data-vault---end-to-end-restaurant-analysis)
    * [Stratum \- DataBricks dbt with Quality and Governance](#stratum---databricks-dbt-with-quality-and-governance)
    * [Build a Iceberg\-based local open data lakehouse](#build-a-iceberg-based-local-open-data-lakehouse)
